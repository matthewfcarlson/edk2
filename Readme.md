...
This branch uses edk2-pytool-base (https://github.com/matthewfcarlson/edk2-pytool-base/)
Doing edksetup.bat will create a virtual environment in BaseTools/.venv if one does not exist.
You can set BASETOOLS_PYTHON_SOURCE to have it be installed locally via `pip install -e`.
